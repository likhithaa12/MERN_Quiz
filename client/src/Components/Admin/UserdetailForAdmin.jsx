...
export const UserdetailForAdmin = (props) => {
  ...
  return (
    <div className="w-full lg:w-4/5 m-auto flex flex-col">
      <div className="bg-teal-500 rounded-lg w-56 mx-auto mb-6 lg:mx-0 lg:mb-0 pl-16 p-4 text-2xl">
        <h1>List of Users</h1>
      </div>
      <div class="flex flex-col container max-w-full lg:max-w-md w-10/12 mx-auto lg:w-3/4  bg-black rounded-lg lg:ml-64">
